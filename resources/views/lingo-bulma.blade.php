...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ mix('css/app.css', 'vendor/lingo') }}">
</head>
                        ...
                        <transition-group tag="ul" name="comp-fade" mode="out-in">
                                ...
                                <div class="column">
                                    ...
                                    <transition name="slide-fade">
                                        <p class="help is-danger"
                                           v-if="dirExist">{{ trans('Lingo::messages.already_exist') }}</p>
                                    </transition>
                                </div>
                            </li>
                            ...
                            <li :key="2" class="columns" v-if="localesList.length || newVendor()">
                                <div class="column is-3">
                                    <p class="title">
                                        {{-- steps --}}
                                        <transition name="slide-fade">
                                            <span v-if="newVendor() && localesList.length == 0"
                                                  class="title has-text-success">2.</span>
                                        </transition>
                                ...
                                <div class="column">
                                    ...
                                    <transition name="slide-fade">
                                        <p class="help is-danger"
                                           v-if="localeExist">{{ trans('Lingo::messages.already_exist') }}</p>
                                    </transition>
                                </div>
                            </li>
                            ...
                            <li :key="3" class="columns" v-if="filesList.length || newVendor()">
                                ...
                                <div class="column">
                                    ...
                                    <transition name="slide-fade">
                                        <p class="help is-danger"
                                           v-if="fileExist">{{ trans('Lingo::messages.already_exist') }}</p>
                                    </transition>
                                </div>
                            </li>
                        </transition-group>
                                            ...
                                            <div class="select">
                                                <select v-model="selectedKeyFormat">
                                                    <option value="" disabled>
                                                        <span>{{ trans('Lingo::messages.key_format') }}</span></option>
...
{{-- Footer --}}
{{-- Scripts --}}
<script src="{{ mix('js/app.js', 'vendor/lingo') }}"></script>
</body>
</html>
